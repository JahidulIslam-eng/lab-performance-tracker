...
{/* Lab porformance heading */}
        ...
        <div className='relative bg-blue-900 w-full flex items-center  px-4 py-4 '>
            ...
            <span  className={`${quintessential.className} text-white  text-xl md:text-4xl`}>LAB PERFORMANCE TRACKER</span>
             <span className='text-white'>(Lab Report Check)</span>
            </div>
{/* Right Side */}
...
<div className="bg-green-200 h-16 w-full flex items-center justify-center px-8 gap-30">
...
<div className='bg-sky-50 flex-1 p-4 overflow-x-auto '>
   <table  className="w-full text-center border border-black text-sm md:text-base">
        <thead>
          ...
          <th className="border border-black p-2 md:p-3">Lab Reports</th>
          <th className="border border-black p-2 md:p-3">Report Marks</th>
          <th className="border border-black p-2 md:p-3">Total Marks</th>
          <th className="border border-black p-2 md:p-3">Avarage Marks</th>
          </tr>
        </thead>
        <tbody>
    ...
    <tr >
       <td className="border border-black p-2 md:p-3">1</td>
            ...
            <td className="border border-black p-2 md:p-3"> Input Marks:
                  <InputNumber 
               onChange={(value) => {
      const newAttendance = [...attendance];

      newAttendance[0] = Number(value) > 0 ? 1 : 0;
      ...
      setAttendance(newAttendance);
            ...
            <td className="border border-black p-2 md:p-3"><button>marks</button></td>
            <td className="border border-black p-2 md:p-3"><button>avg</button></td>
            </tr>
       ...
       <td className="border border-black p-2 md:p-3">2</td>
            ...
            <td className="border border-black p-2 md:p-3">  Input Marks: <InputNumber 
               onChange={(value) => {
      const newAttendance = [...attendance];
